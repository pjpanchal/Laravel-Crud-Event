        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" enctype="multipart/form-data"  method="POST" action="<?php echo e(route('events.store')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('description') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="description" class="form-control" name="description" value="<?php echo e(old('description')); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('startdate') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="startdate" type="date" class="form-control" name="startdate" value="<?php echo e(old('startdate')); ?>" required>
