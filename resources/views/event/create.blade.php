        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" enctype="multipart/form-data"  method="POST" action="{{ route('events.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('startdate') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="startdate" type="date" class="form-control" name="startdate" value="{{ old('startdate') }}" required>
